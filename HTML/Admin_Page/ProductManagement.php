        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-form" id="detail-form">
                ...
                <div class="row">
                    <div>Is Promoted</div>
                    <div class="dropdown">
                        <button disabled id="detail-promote" class="btn btn-secondary dropdown-toggle" type="button"
                ...
                <div class="row">
                    <div>Category</div>
                    <div class="dropdown">
                        <button disabled id="detail-category" class="btn btn-secondary dropdown-toggle" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                            Dropdown button
                        </button>
                        <ul class="dropdown-menu">
