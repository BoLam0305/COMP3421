            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-form" id="item-form">
                    ...
                    <div class="row">
                        <div>Status</div>
                        <div class="dropdown">
                            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="add_status">Enable</a>
                    ...
                    <div class="row">
                        <div>User Type</div>
                        <div class="dropdown">
                            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="add_userType">User</a>
                            <ul class="dropdown-menu">
